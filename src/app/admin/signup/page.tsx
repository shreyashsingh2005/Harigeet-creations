        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          {step === 1 ? (
            <>
              ...
              <Link href="/admin/login" className="font-medium text-[#D4AF37] hover:text-[#b08d27] transition-colors">
                Sign in here
              </Link>
            </>
          ) : (
          ...
          {step === 1 ? (
            <form className="space-y-6" onSubmit={handleSendOtp}>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input type="text" required value={name} onChange={(e) => setName(e.target.value)} className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#D4AF37] focus:border-[#D4AF37] sm:text-sm" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#D4AF37] focus:border-[#D4AF37] sm:text-sm" />
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-1 gap-3">
                  <button type="button" onClick={() => signIn("google", { callbackUrl: "/admin" })} className="w-full inline-flex justify-center py-2.5 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
            ...
            <form className="space-y-6" onSubmit={handleVerifyOtp}>
              ...
              <div className="text-center mt-4">
                <button type="button" onClick={() => setStep(1)} className="text-sm text-gray-500 hover:text-[#D4AF37]">
